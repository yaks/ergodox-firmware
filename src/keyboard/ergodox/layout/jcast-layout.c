...
KB_MATRIX_LAYER(
	...
	KEY_Backslash_Pipe,	KEY_q_Q,	KEY_w_W,	KEY_e_E,	KEY_r_R,	KEY_t_T,	2,	
	KEY_Tab,	KEY_a_A,	KEY_s_S,	KEY_d_D,	KEY_f_F,	KEY_g_G,	
	KEY_LeftShift,	KEY_z_Z,	KEY_x_X,	KEY_c_C,	KEY_v_V,	KEY_b_B,	1,	
	KEY_LeftControl,	KEY_Equal_Plus,	KEY_Backslash_Pipe,	KEY_LeftArrow,	KEY_RightArrow,	
	KEY_LeftGUI,	KEY_LeftAlt,	
	0,	0,	KEY_Home,	
	KEY_DeleteBackspace,	KEY_DeleteForward,	KEY_End,	
	// right hand
	KEY_Escape,	KEY_6_Caret,	KEY_7_Ampersand,	KEY_8_Asterisk,	KEY_9_LeftParenthesis,	KEY_0_RightParenthesis,	KEY_Dash_Underscore,	
...
KB_MATRIX_LAYER(
	...
	2,	0,	KEYPAD_7_Home,	KEYPAD_8_UpArrow,	KEYPAD_9_PageUp,	KEYPAD_Plus,	0,	
